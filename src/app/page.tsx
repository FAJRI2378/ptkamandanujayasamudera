          ...
          <div className={`text-center ${visibleSections['home'] ? 'slide-in-bottom' : 'opacity-0'}`}>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-10 max-w-3xl mx-auto">
              {['Ship Management', 'Crew Manning', 'Vessel Operations', 'Maritime Services', 'STCW Certified'].map((tag, idx) => (
                <span 
                  key={idx} 
                  className={`px-4 py-2 bg-blue-500/20 border border-blue-400 text-blue-200 rounded-full text-sm font-medium backdrop-blur-sm ${
                    visibleSections['home'] ? 'scale-in' : 'opacity-0'
                  } stagger-${idx + 1}`}
                >
                  {tag}
                </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#contact"
                className={`inline-flex items-center justify-center px-8 py-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all transform hover:scale-105 shadow-xl font-semibold text-lg group ${
                  visibleSections['home'] ? 'slide-in-bottom' : 'opacity-0'
                } stagger-2`}
              >
              ...
              <a
                href="#services"
                className={`inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white rounded-lg hover:bg-white hover:text-[#0A2540] transition-all font-semibold text-lg ${
                  visibleSections['home'] ? 'slide-in-bottom' : 'opacity-0'
                } stagger-3`}
              >
                Explore Services
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {stats.map((stat, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`text-center bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-500 hover:scale-105 ${
                    visibleSections['home'] ? 'slide-in-bottom' : 'opacity-0'
                  } stagger-${index + 1}`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {fleet.map((vessel, index) => (
              <article
                key={index}
                className={`bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-200 ${
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-105 group cursor-pointer ${
                    visibleSections['facilities'] ? 'scale-in' : 'opacity-0'
                  } stagger-${index + 1}`}
